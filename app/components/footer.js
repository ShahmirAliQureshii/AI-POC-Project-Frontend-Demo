      ...
      <div className="max-w-7xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Beautiful face recognition UI — demo frontend for your
                  project.
                </p>
              </div>
            </div>
            ...
            <div className="text-sm text-slate-400">
              <p>
                Ship polished demos faster. When you're ready I can wire backend
                endpoints for uploads, inference and realtime dashboard updates.
              </p>
            </div>
            ...
            <div className="flex gap-3 mt-3">
              <a
                aria-label="GitHub"
                href="#"
                className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white/6 hover:bg-white/10 transition"
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
        ...
        <div className="mt-10 md:mt-12 bg-gradient-to-r from-white/3 to-white/2 rounded-2xl p-5 md:p-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-300">
              Get occasional updates and design previews — frontend demo only.
            </p>
          </div>
          ...
          >
            ...
            />
            <button className="px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-semibold">
              Subscribe
            </button>
          </form>
        ...
        <div className="mt-8 border-t border-white/6 pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-sm text-slate-400">
          <div>
            ...
            <span className="text-white font-semibold">AI POC Labs</span>. All
            rights reserved.
          </div>
